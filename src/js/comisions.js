...
d.addEventListener('DOMContentLoaded', async e => {
  ...
  $comisionGeneral = d.getElementById('is-general');
  $liErrors = d.getElementById('errors');


  // INPUTS DE LA MODAL
  $nombreComisionComisionModal = d.querySelector('#editComisionsModal #name');
  ...
  $comisionGeneralComisionModal = d.querySelector('#editComisionsModal #is-general');
